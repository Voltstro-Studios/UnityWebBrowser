...
namespace UnityWebBrowser.Tests
{
    public class LoggerTests
    {
        ...
        {
            const string json = "{\"@t\":\"2022-01-02T07:42:28.3014491Z\",\"@m\":\"Some message...\",\"@i\":\"82d21ca4\",\"@l\":\"Debug\"}";
        ...
        {
            const string json = "{\"@t\":\"2022-01-02T07:42:28.3014491Z\",\"@m\":\"Some message...\",\"@i\":\"82d21ca4\"}";
            JsonLogStructure logStructure = ProcessLogHandler.ReadJsonLog(json);
        ...
        {
            const string json = "{\"@t\":\"2022-01-02T07:42:28.3014491Z\",\"@m\":\"Some message...\",\"@i\":\"82d21ca4\",\"@l\":\"Warning\"}";
            JsonLogStructure logStructure = ProcessLogHandler.ReadJsonLog(json);
        ...
        {
            const string json = "{\"@t\":\"2022-01-02T07:42:28.3014491Z\",\"@m\":\"Some message...\",\"@i\":\"82d21ca4\",\"@l\":\"Error\"}";
            JsonLogStructure logStructure = ProcessLogHandler.ReadJsonLog(json);
