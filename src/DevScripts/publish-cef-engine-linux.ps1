...
Copy-Item -Path "../UnityWebBrowser.Engine.Cef/bin/ReleaseUnity/linux-x64/publish/*" -Destination "../Packages/UnityWebBrowser/Plugins/CefBrowser/linux-x64/" -Recurse -Force -PassThru